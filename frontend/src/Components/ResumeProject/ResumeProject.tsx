      ...
      <div className="resume-project">
        ...
        <div className="text-resume">
          ...
          <div className="display-text">
            ...
            habitant local ou un touriste en visite, notre service de location
            de vélos vous permet d'explorer la ville à votre rythme.
            Imaginez-vous pédalant le long des rues pittoresques, découvrant des
            quartiers animés et des sites emblématiques en chemin.
          </div>
          <div className="display-text">
            Avec Rent Bike, vous avez la liberté de créer votre propre
            itinéraire et de vivre une expérience authentique. Notre processus
            de location est simple et rapide. Il vous suffit de télécharger
            notre application conviviale, de choisir la station de location la
            plus proche et de réserver votre vélo en quelques clics. Nous
            proposons une large gamme de vélos adaptés à tous les besoins : des
            vélos de ville élégants aux VTT robustes pour les aventuriers.
            Lorsque vous récupérez votre vélo à la station, vous constaterez que
